...
if (isset($_GET['erreur'])) {
    $erreur = htmlspecialchars(trim($_GET['erreur']));
...
if (isset($_POST['fullname'], ($_POST['mail']), ($_POST['subject']), ($_POST['comment']))) {
    ...
    try {
        ...
        $mail->addAddress('*******', $fullname);     // Add a recipient
        ...
        <div class="mbr-row">
            <div class="mbr-col-lg-5 mbr-col-md-12 mbr-m-auto mbr-col-sm-12 md-pb">
                <div class="content">
                    ...
                    <p class="mbr-fonts-style mbr-text align-left mbr-pb-5  display-7">Unique glasses for a new era
                        of fashion.</p>
                    <div class="mbr-section-btn align-left"><a class="btn btn-md btn-white-outline display-4" href="/lunettes"><span class="mobi-mbri mobi-mbri-right mbr-iconfont mbr-iconfont-btn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="19" height="19">
            ...
            <div class="mbr-col-lg-7 mbr-col-md-12 img-col mbr-m-auto mbr-col-sm-12">
                <div class="img-wrapper">
                    <amp-img src="public/images/01.jpg" alt="" width="1099.8670212765958" height="919" layout="responsive" class="mobirise-loader mbr-m-auto align-center">
        ...
        <div class="mbr-row">
            <div class="mbr-col-lg-6 mbr-col-md-6 col1 mbr-m-auto mbr-col-sm-12">
                ...
                <div class="content">
                    ...
                    <div class="mbr-section-btn mbr-pt-5 align-left"><a class="btn btn-md btn-white-outline display-4" href="/femme"><span class="mobi-mbri mobi-mbri-right mbr-iconfont mbr-iconfont-btn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="19" height="19">
                                    <path d="M24 11l-6.7 6.7-1.4-1.4 4.3-4.3H0v-2h20.2l-4.3-4.3 1.4-1.4L24 11z"></path>
                                </svg></span>Shop Now</a>
                    </div>
                </div>
            ...
            <div class="mbr-col-lg-6 mbr-col-md-6 col2 mbr-m-auto mbr-col-sm-12">
                ...
                <div class="content">
                    ...
                    <div class="mbr-section-btn mbr-pt-5 align-left"><a class="btn btn-md btn-white-outline display-4" href="/homme"><span class="mobi-mbri mobi-mbri-right mbr-iconfont mbr-iconfont-btn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="19" height="19">
                                    <path d="M24 11l-6.7 6.7-1.4-1.4 4.3-4.3H0v-2h20.2l-4.3-4.3 1.4-1.4L24 11z"></path>
                                </svg></span>Shop Now</a>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="mbr-row">
            <div class="mbr-col-lg-6 mbr-col-md-12 img-col mbr-m-auto md-pb mbr-col-sm-12">
                <div class="img-wrapper">
                    <amp-img src="public/images/background1.jpg" alt="" width="651.8163265306123" height="779" layout="responsive" class="mobirise-loader mbr-m-auto align-center">
                        <div placeholder="" class="placeholder">
                            <div class="mobirise-spinner">
                                <em></em>
                                <em></em>
        ...
        <div class="mbr-row mbr-jc-c">
            <div class="card md-pb mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <amp-img src="public/images/01.jpg" layout="responsive" width="718.0851063829788" height="600" alt="" class="mobirise-loader">
                            <div placeholder="" class="placeholder">
                                <div class="mobirise-spinner">
                                    <em></em>
                                    <em></em>
            ...
            <div class="card md-pb mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <amp-img src="public/images/03.jpg" layout="responsive" width="453.6170212765957" height="600" alt="" class="mobirise-loader">
                            <div placeholder="" class="placeholder">
                                <div class="mobirise-spinner">
                                    <em></em>
                                    <em></em>
            ...
            <div class="card md-pb mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-4 last-child">
                <div class="card-wrapper">
                    <div class="card-img">
                        <amp-img src="public/images/04.jpg" layout="responsive" width="390.9836065573771" height="600" alt="" class="mobirise-loader">
                            <div placeholder="" class="placeholder">
                                <div class="mobirise-spinner">
                                    <em></em>
                                    <em></em>
    ...
    <div class="container">
        <div class="mbr-row">
            ...
            <div class="mbr-col-lg-7 mbr-col-md-12  mbr-m-auto mbr-col-sm-12 md-pb">
                <div class="img-wrapper">
                    <amp-img src="public/images/02.jpg" alt="" width="766" height="766" layout="responsive" class="mobirise-loader mbr-m-auto align-center">
                        <div placeholder="" class="placeholder">
                            <div class="mobirise-spinner">
                                <em></em>
                                <em></em>
    ...
    <div class="container">
        <div class="mbr-row mbr-jc-c">
            ...
            <div class="mbr-col-lg-1 mbr-col-md-3 mbr-col-sm-12">
                <div class="img-wrapper">
                    <amp-img src="public/images/1.png" alt="" width="104.39999999999999" height="87" layout="responsive" class="mobirise-loader mbr-m-auto align-center">
                        <div placeholder="" class="placeholder">
                            <div class="mobirise-spinner">
                                <em></em>
                                <em></em>
            ...
            <div class="mbr-col-lg-1 mbr-col-md-3 mbr-col-sm-12">
                <div class="img-wrapper">
                    <amp-img src="public/images/2.png" alt="" width="104.39999999999999" height="87" layout="responsive" class="mobirise-loader mbr-m-auto align-center">
                        <div placeholder="" class="placeholder">
                            <div class="mobirise-spinner">
                                <em></em>
                                <em></em>
            ...
            <div class="mbr-col-lg-1 mbr-col-md-3 mbr-col-sm-12">
                <div class="img-wrapper">
                    <amp-img src="public/images/3.png" alt="" width="104.39999999999999" height="87" layout="responsive" class="mobirise-loader mbr-m-auto align-center">
                        <div placeholder="" class="placeholder">
                            <div class="mobirise-spinner">
                                <em></em>
                                <em></em>
            ...
            <div class="mbr-col-lg-1 mbr-col-md-3 mbr-col-sm-12">
                <div class="img-wrapper">
                    <amp-img src="public/images/4.png" alt="" width="104.39999999999999" height="87" layout="responsive" class="mobirise-loader mbr-m-auto align-center">
                        <div placeholder="" class="placeholder">
                            <div class="mobirise-spinner">
                                <em></em>
                                <em></em>
            ...
            <div class="mbr-col-lg-1 mbr-col-md-3 mbr-col-sm-12">
                <div class="img-wrapper">
                    <amp-img src="public/images/5.png" alt="" width="104.39999999999999" height="87" layout="responsive" class="mobirise-loader mbr-m-auto align-center">
                        <div placeholder="" class="placeholder">
                            <div class="mobirise-spinner">
                                <em></em>
                                <em></em>
    ...
    <div class="container">
        <div class="mbr-row">
            ...
            <div class="mbr-col-lg-6 mbr-col-md-12 mbr-col-sm-12 md-pb mbr-form" data-form-type="formoid">
                ...
                <!--Formbuilder Form-->
                <form method="POST" class="mbr-form" data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true" value="7pvecEC03Vl+iE4OgQhJAcIKUvNYgbOybompFz5FUt3dVJFrkL+iG/xWutYm3nUCmEi/c4T1pNdb2AAoQ8xvTPYYbZ4xYaU1nPta8EIdnJ+Y4Tg20XU3s+66FlGtbrNh.G2Kid/KefslhAU0N2UdYn90LIQRTfVa0AjTyWXz86bWEg6Xl4Y/o7kjTXS9C7ZEP560NTnn8j/doIZNHJa6LgqlruO85KB+iQaFXyH185Q4Y6spTW2FPPRLr2XFr3x5Y">
                    <div class="mbr-row">
                    ...
                    <div class="dragArea mbr-row">
                        <div class="mbr-col-lg-12 mbr-col-md-12 mbr-col-sm-12 field" data-for="form[data][0][1]">
                            <input type="hidden" name="form[data][0][0]" value="name" id="form[data][0][0]-form01-a" data-form-field="">
                            <input type="text" name="fullname" placeholder="Full Name" data-form-field="name" class="field-input display-7" value="" id="form[data][0][1]-form01-a">
                        </div>
                        <div class="mbr-col-lg-12 mbr-col-md-12 mbr-col-sm-12 field" data-for="form[data][1][1]">
                            <input type="hidden" name="form[data][1][0]" value="email" id="form[data][1][0]-form01-a" data-form-field="">
                            <input type="email" name="mail" placeholder="Email" data-form-field="email" class="field-input display-7" value="" id="form[data][1][1]-form01-a">
                        </div>
                        <div data-for="form[data][2][1]" class="mbr-col-lg-12 mbr-col-md-12 mbr-col-sm-12 field">
                            <input type="hidden" name="form[data][2][0]" value="text" id="form[data][2][0]-form01-a" data-form-field="">
                            <input type="text" name="subject" placeholder="Subject" data-form-field="text" class="field-input display-7" value="" id="form[data][2][1]-form01-a">
                        </div>
                        <div data-for="form[data][3][1]" class="mbr-col-lg-12 mbr-col-md-12 mbr-col-sm-12 field">
                            <input type="hidden" name="form[data][3][0]" value="message" id="form[data][3][0]-form01-a" data-form-field="">
                            <textarea name="comment" placeholder="Comment" data-form-field="message" class="field-input display-7" id="form[data][3][1]-form01-a"></textarea>
                        </div>
                        <div class="mbr-col-auto"><button name="send" type="submit" class="btn btn-black display-7">Send</button></div>
                    </div>
                    <span class="gdpr-block">
                        <label>
                            <span class="textGDPR" style="color: #a7a7a7"><input type="checkbox" name="gdpr" id="gdpr-form01-a" required="">By continuing you agree to our <a style="color: #767676; text-decoration: none;" href="terms.html">Terms of Service</a> and <a style="color: #767676; text-decoration: none;" href="policy.html">Privacy Policy</a>.</span>
                        </label>
                    </span>
                </form>
                <!--Formbuilder Form-->
    ...
    <div class="container-fluid">
        <div class="mbr-row mbr-jc-c">
            ...
            <div class="google-map">
                <amp-iframe src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAEIpgj38KyLFELm2bK9Y7krBkz1K-cMq8&amp;q=place_id:ChIJn6wOs6lZwokRLKy1iqRcoKw" height="400" layout="fill" sandbox="allow-scripts allow-same-origin                                 allow-popups" frameborder="0" class="mobirise-loader">
                    <div placeholder="" class="placeholder">
                        <div class="mobirise-spinner">
                            <em></em>
                            <em></em>
        ...
        <div class="mbr-row">
            ...
            <div class="mbr-col-lg-3 mbr-col-md-12 mbr-col-sm-12 mbr-form" data-form-type="formoid">
                <div class="wrapper" data-form-type="formoid">
                    ...
                    <!--Formbuilder Form-->
                    <form method="POST" class="mbr-form" action-xhr="https://formoid.net/api/amp-form/push" data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true" value="HtF1iBUotMsMfmBeRiMPzukCaspWcsDY20EWrfGUve2cyaXE/B79OYFL1p3zl8cuGVWEZBjYhEzysAfAC4OwYm4j7IVjddpksGT5cqgGlXfEDUwWrHoI1S87PQF/1YV+.KbdmngwckKva3gCbnQH5BpAG3yN/Wthth3vjtfeYvhhlGPMODCE120YsVSIffUUiFPWLNxLwMPDa2ZM1/QvFGR+9ZSm1beV14FfWHMTQfAzD/C/GqPO4eIJjevSipROA">
                        <div class="mbr-row">
                            <div submit-success="" class="mbr-col-lg-12 mbr-col-md-12 mbr-col-sm-12">
                                <template data-form-alert="" type="amp-mustache">Thanks for filling out the
                                    form!</template>
                            </div>
                            <div submit-error="" class="mbr-col-lg-12 mbr-col-md-12 mbr-col-sm-12">
                                <template data-form-alert="" type="amp-mustache">Failed! {{error}}</template>
                        ...
                        <div class="dragArea mbr-row">
                            <div class="mbr-col field" data-for="form[data][0][1]">
                                <input type="hidden" name="form[data][0][0]" value="email" id="form[data][0][0]-footer02-7" data-form-field="">
                                <input type="email" name="form[data][0][1]" placeholder="Enter email here" data-form-field="email" class="field-input display-7" value="" id="form[data][0][1]-footer02-7">
                            </div>
                            <div class="mbr-col-auto"><button type="submit" class="btn btn-black display-7"><span class="mobi-mbri mobi-mbri-right mbr-iconfont mbr-iconfont-btn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="19" height="19">
                                            <path d="M24 11l-6.7 6.7-1.4-1.4 4.3-4.3H0v-2h20.2l-4.3-4.3 1.4-1.4L24 11z"></path>
                                        </svg></span></button>
                            </div>
                        </div>
                        <span class="gdpr-block">
                            <label>
                                <span class="textGDPR" style="color: #a7a7a7"><input type="checkbox" name="gdpr" id="gdpr-footer02-7" required="">By continuing you agree to our <a style="color: #767676; text-decoration: none;" href="terms.html">Terms of Service</a> and <a style="color: #767676; text-decoration: none;" href="policy.html">Privacy Policy</a>.</span>
                            </label>
                        </span>
                    </form>
                    <!--Formbuilder Form-->
